...
[ client:
  ...
  # User-Agent header; generated by client-go when omitted
  [ user_agent: <string> ]

  # Maximum time to read a response; limited by module timeout
  [ read_timeout: <duration> | default = module timeout ]

  # Maximum TCP connection time; limited by module timeout
...
- [`queries.md`](examples/queries.md) - Example Prometheus queries.
...
- [`dashboard.json`](contrib/grafana/dashboard.json) - Simple dashboard that tracks certificate expiration dates and target connection errors.
